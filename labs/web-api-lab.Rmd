...
```{r}
library(rvest)
a_url = "./labs/bioc-software.html"
htmlfile1 = html(a_url)
nds = html_nodes(htmlfile1,
...
```{r}
text=paste(dat_scrape[,3], collapse=" ")
...
API documentation: http://rest.ensembl.org/documentation/info/lookup
