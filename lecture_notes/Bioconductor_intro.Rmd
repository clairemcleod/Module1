...
probe_data_dt[PROBEID == "1007_s_at"]
probe_data_dt_unique <- probe_data_dt[,list(SYMBOL = paste(SYMBOL, collapse = ";")), by = "PROBEID"]
probe_data_dt_unique[SYMBOL %like% ";"]
```
So about 1200 probes map to multiple genes (a relatively small fraction of the total # of probes)
...
Let's get our data ready (b/c ggplot expects regtangular DF)
...
md_long_short <- fd[md_long[sd_probe > .5] , nomatch = 0] #inner join on the small table (high stdev)
```
